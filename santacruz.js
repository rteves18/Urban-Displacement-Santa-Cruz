...
function refresh() {
    ...
    d3.json(json_files[current_json_file], function(error, sc) {
        ...
        svg.append("path")
            .datum(topojson.mesh(sc, sc.objects.sctracts, function(a, b) {
                return a !== b;
            }))
...
function getToolTipLabel(d) {
    ...
    var finalLabel = "<strong><div style='text-align:center;'>" +
        legendText + "</div></strong></br>"
        //
        + "<table><tr><th>Year</th><th>Total</th></tr>" + "<tr>" + "<tr><th>" + this.year + "</th><th><font color ='" + label_color + "'>" + sign + year_data;
